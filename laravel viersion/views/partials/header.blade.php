...
<html lang="en">
    ...
    <body class="container-fluid">
        ...
        <nav id="nav" style="display:flex; justify-content: space-evenly;">
            <div><a href="/" class="text-primary">Home</a></div>
            <div><a href="/page/contacts" class="text-primary">Contacts</a></div>
            <?php if(isset($_SESSION["auth"]) && $_SESSION["auth"]=="true" && isset($_SESSION["verified"]) && $_SESSION["verified"]==1){ ?>
            <div><a href="/page/gallery?user=<?= $_SESSION["id"] ?>" class="text-primary">Gallery</a></div>
            <?php } ?>
            <div><a href="/page/login_mobile" class="text-primary">Login/Profile</a></div>
            <div><a href="/page/create_user" class="text-primary">SignUp</a></div>
        </nav>
